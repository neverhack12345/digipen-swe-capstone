...
const PlanSchema = z.object({
  ...
  yearsProjected: z.coerce.number().int().min(1, "Year projected cannot be less than 1"),
});

export default function PlanForm( { setData, setIsCompleteLoaded }: 
  {setData: Dispatch<SetStateAction<Plan[]>>, setIsCompleteLoaded: Dispatch<SetStateAction<boolean>>}) {
  const TITLE = "Plan";
          ...
          <div className="w-full flex-wrap gap-4">
            ...
            <Spacer y={1} />
              <Input
                ...
                color="default"
                errorMessage={
                  errors.interestPerYear !== undefined ? errors.interestPerYear?.message : ""
                }
            ...
            <Spacer y={1} />
              <Input
                ...
                color="default"
                errorMessage={
                  errors.yearlyContribution !== undefined ? errors.yearlyContribution?.message : ""
                }
              ...
              <Input
                ...
                color="default"
                errorMessage={
                  errors.yearsContributing !== undefined ? errors.yearsContributing?.message : ""
                }
              ...
              <Input
                ...
                color="default"
                errorMessage={
                  errors.yearlyWithdrawAmount !== undefined ? errors.yearlyWithdrawAmount?.message : ""
                }
              ...
              <Input
                ...
                color="default"
                errorMessage={
                  errors.yearStartWithdraw !== undefined ? errors.yearStartWithdraw?.message : ""
                }
              ...
              <Input
                ...
                color="default"
                errorMessage={
                  errors.yearsProjected !== undefined ? errors.yearsProjected?.message : ""
                }
